...
def run_module():
    ...
    if state == 'present' and number is None:
        try:
            ...
            snow_error = "Failed to create record: {0}, details: {1}, exception: {2}".format(e.error_summary, e.error_details, str(e))
            module.fail_json(msg=snow_error, **result)
    ...
    # we are deleting a record
        ...
        try:
            ...
            snow_error = "Failed to delete record: {0}, details: {1}, exception: {3}".format(e.error_summary, e.error_details, str(e))
            module.fail_json(msg=snow_error, **result)
        except Exception as detail:
    ...
    # We want to update a record
        ...
        try:
            ...
            snow_error = "Failed to update record: {0}, details: {1}, exception: {3}".format(e.error_summary, e.error_details, str(e))
            module.fail_json(msg=snow_error, **result)
        except Exception as detail:
