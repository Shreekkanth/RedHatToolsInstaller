...
#-------------------------------
echo "*********************************************************"
echo "ADMIN PASSWORD - What would you like you web interface or
                       your foreman, Satellite, or ansible Tower
                       user 'admin' password to be?"
echo "*********************************************************"
...
echo "*********************************************************"
echo "ADDING KATELLO-CVMANAGER TO ~/GIT "
echo "*********************************************************"
cd ~/git
git clone https://github.com/RedHatSatellite/katello-cvmanager.git
git clone https://github.com/oasis-roles/satellite.git
...
yum-builddep -y foreman-proxy --skip-broken
echo " "
...
source /root/.bashrc
for i in $(find ~/Downloads/ |grep manifest* ); do sudo -u admin hammer subscription upload --file $i --organization $ORG ; done || exit 1
