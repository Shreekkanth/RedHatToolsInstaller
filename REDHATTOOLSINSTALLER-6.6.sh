...
sleep 5
yum install -y screen syslinux python-pip python3-pip rubygems yum-utils vim gcc gcc-c++ git make automake kernel-devel libvirt-client bind dhcp tftp libvirt augeas ruby --skip-broken
sleep 5
echo " "
echo " "
echo " "
...
1. Ansible-Tower will require a subscription.
