...
echo '
                                ANSIBLE-TOWER 3.6.4 INSTALLER FOR RHEL 7.x AND RHEL 8.x
...
mkdir ~/Downloads
cd ~/Downloads
wget https://releases.ansible.com/ansible-tower/setup-bundle/ansible-tower-setup-bundle-3.6.4-1.el7.tar.gz ~/Downloads
cd ~/Downloads
tar -zxvf ~/Downloads/ansible-tower-setup-bundle-3.6.4-1.el7.tar.gz 
cd ~/Downloads/ansible-tower-setup-bundle-3.6.4-1
yum localinstall -y --skip-broken ~/Downloads/ansible-tower-setup-bundle-3.6.4-1/bundle/el7/repos/ansible-tower-dependencies/*.rpm
sleep 2
echo " "
echo " " 
cd 
...
mkdir ~/Downloads
cd ~/Downloads
wget https://releases.ansible.com/ansible-tower/setup-bundle/ansible-tower-setup-bundle-3.6.4-1.el8.tar.gz
cd ~/Downloads
tar -zxvf ~/Downloads/ansible-tower-setup-bundle-3.6.4-1.el8.tar.gz 
cd ~/Downloads/ansible-tower-setup-bundle-3.6.4-1
dnf localinstall -y --skip-broken ~/Downloads/ansible-tower-setup-bundle-3.6.4-1/bundle/el8/repos/ansible-tower-dependencies/*.rpm --best --allowerasing
sleep 2
echo " "
echo " "
echo 'What would you like your default Ansible Tower user "admin" password to be?'
